...
# ---------------------------------------------------------------------------
# UI SETUP  (stili vjen kryesisht nga .streamlit/config.toml, jo nga CSS)
# ---------------------------------------------------------------------------
...
st.markdown(
    ...
    .main-header h1 { margin: 0; font-size: 2rem; font-weight: 800; letter-spacing: -0.5px; color: white; }
    .main-header p { margin: 0.5rem 0 0.9rem 0; opacity: 0.92; font-size: 1rem; max-width: 620px; line-height: 1.4; color: white;}
    .badge {
        display: inline-block; margin-right: 0.4rem; padding: 0.32rem 0.85rem; border-radius: 999px;
        background: rgba(255,255,255,0.18); font-size: 0.78rem; font-weight: 600; color: white;
    }
    .section-title { font-weight: 700; font-size: 1.05rem; color: #4f46e5; margin-bottom: 0.4rem; }
    .result-card {
        border-radius: 16px; padding: 1.3rem 1.5rem; margin-top: 0.6rem;
        box-shadow: 0 6px 20px rgba(17,24,39,0.08);
    }
    .result-fake { background: #fef2f2; border: 1px solid #fecaca; }
